...
import { Check, Plus, Minus, Layers, Zap, Compass, Code } from 'lucide-react';
...
export const ServicesPage = ({ onOpenStartProject, onOpenContact }: ServicesPageProps) => {
  ...
  return (
    <div className="w-full bg-[#fcfbf9] text-neutral-950 pb-28 select-none">
      ...
      {/* 2. Featured Services Reel */}
      <section className="w-full px-6 sm:px-10 md:px-14 lg:px-20 pb-8 sm:pb-12">
        <div className="max-w-7xl mx-auto">
          <div className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-neutral-950 aspect-[16/10] sm:aspect-[16/8] md:aspect-[21/8] min-h-[260px] sm:min-h-[330px] md:min-h-[380px] shadow-sm">
            <video
      ...
      <section className="w-full px-6 sm:px-10 md:px-14 lg:px-20 pt-6 sm:pt-10 pb-16 sm:pb-24 border-t border-neutral-200/80">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            {SERVICE_CAPABILITIES.map((service, idx) => {
              ...
              return (
                <div
                  ...
                  className="group bg-white p-8 sm:p-10 border border-neutral-200/80 shadow-xs hover:bg-[#dbfa07] hover:border-[#dbfa07] hover:shadow-md transition-all flex flex-col justify-between"
                >
                  <div>
                    <div className="w-12 h-12 rounded-sm bg-neutral-100 flex items-center justify-center text-neutral-950 mb-6 group-hover:bg-neutral-950 group-hover:text-[#dbfa07] transition-colors">
                      <Icon className="w-6 h-6" />
                    </div>
                    <h3 className="text-2xl font-bold uppercase tracking-tight text-neutral-950 mb-3">
                      {service.title}
                    </h3>
                    <p className="text-sm text-neutral-700 group-hover:text-neutral-950 leading-relaxed font-normal mb-6 transition-colors">
                      {service.description}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    {isExpanded && (
                      <ul className="pt-3 space-y-2 text-xs text-neutral-600 group-hover:text-neutral-950 font-medium transition-colors">
      ...
      <section className="w-full px-6 sm:px-10 md:px-14 lg:px-20 pt-8 sm:pt-12 pb-16 sm:pb-20 border-t border-neutral-200/80">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            <span className="text-[11px] sm:text-xs font-bold tracking-[0.2em] uppercase text-neutral-500 block mb-2">
              HOW WE WORK
      ...
      <section className="w-full px-6 sm:px-10 md:px-14 lg:px-20 pt-8">
        <div
          ...
          className="relative max-w-7xl mx-auto overflow-hidden bg-[#181a33] text-white p-10 sm:p-14 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8"
        >
          <video
          ...
          <div className="relative z-10 flex items-center gap-4 flex-wrap">
            <button
              ...
              className="px-8 py-4.5 rounded-full border border-white/40 text-white font-medium text-xs sm:text-sm tracking-normal uppercase hover:bg-white hover:text-black transition-all duration-300 cursor-pointer shrink-0 inline-flex items-center gap-2"
            >
