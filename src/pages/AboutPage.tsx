...
export const AboutPage = ({ onOpenStartProject }: AboutPageProps) => {
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      setStatValues({
        valueCreated: Math.round(eased * target.valueCreated),
        hoursInvested: Math.round(eased * target.hoursInvested),
        projectsDelivered: Math.round(eased * target.projectsDelivered),
      });
  ...
  return (
    <div className="w-full bg-[#fcfbf9] text-neutral-950 pb-28 select-none overflow-x-hidden">
      ...
      <section className="w-full px-6 md:px-12 lg:px-16 pt-8 md:pt-14 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-neutral-950 aspect-[16/10] sm:aspect-[16/8] md:aspect-[21/8] min-h-[260px] sm:min-h-[330px] md:min-h-[380px] shadow-sm mb-16 sm:mb-24 group"
          >
            <video
          ...
          >
            ...
            <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20 px-4">
              <motion.p
                ...
                className="text-[23px] sm:text-[23px] md:text-[23px] text-neutral-900 font-medium leading-relaxed tracking-[-0.02em]"
              >
            ...
            <div
              ref={statsRef}
              className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 divide-y sm:divide-y-0 sm:divide-x divide-neutral-200 text-center"
            >
              <motion.div
          ...
          <div className="pt-8 sm:pt-12">
            ...
            <motion.div
              ...
              className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-neutral-900 aspect-[16/10] sm:aspect-[16/8] md:aspect-[21/8] min-h-[260px] sm:min-h-[330px] md:min-h-[380px] shadow-lg group cursor-pointer"
            >
              <video
              ...
              {/* Bottom-Left Tag: Bizzjump Build with us */}
      ...
      {/* =========================================================================
          SECTION 2: CORE TEAM - COMMENTED OUT PER REQUEST
          ========================================================================= */}
      {/*
