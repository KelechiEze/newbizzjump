  ...
  return (
    <div className="w-full bg-[#fcfbf9] text-neutral-950 pb-28 select-none">
      ...
      <section className="w-full px-6 sm:px-10 md:px-14 lg:px-20 pt-10">
        <div className="relative max-w-7xl mx-auto overflow-hidden rounded-[10px] bg-[#181a33] text-white p-10 sm:p-14 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
          <video
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#181a33]/90 via-[#181a33]/75 to-[#181a33]/65" />
          ...
          <button
            ...
            className="relative z-10 px-8 py-4.5 rounded-full bg-[#dbfa07] text-black font-medium text-xs sm:text-sm tracking-normal uppercase hover:bg-white hover:text-black transition-all duration-300 shadow-md cursor-pointer shrink-0 inline-flex items-center gap-2"
          >
