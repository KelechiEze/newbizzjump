...
export const PricingSection = ({ onOpenStartProject }: PricingSectionProps) => {
  return (
    <section
      id="pricing-section"
      className="w-full px-6 sm:px-10 md:px-14 lg:px-16 pt-10 sm:pt-12 md:pt-16 pb-20 sm:pb-28 bg-[#fcfbf9] border-t border-neutral-200/80 select-none"
    >
            ...
            >
              ...
              <div className="pt-4 border-t border-neutral-200/80">
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-full font-medium text-xs tracking-normal uppercase inline-flex items-center justify-center gap-2 transition-all duration-300 shadow-sm active:scale-[0.98] cursor-pointer group ${
                    isPopular
