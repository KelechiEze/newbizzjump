    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-md flex items-center justify-center p-4 select-none">
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl bg-[#fcfbf9] text-neutral-900 rounded-[6px] shadow-2xl overflow-hidden z-10 my-auto p-6 md:p-10 border border-neutral-200 flex flex-col max-h-[90vh]"
        >
          {/* Header */}
          <div className="flex items-center justify-between pb-6 border-b border-neutral-200">
            <div>
              <span className="text-[11px] font-bold tracking-widest uppercase text-neutral-500 block mb-1">
                BIZZJUMP • COMPLETE SELECTED WORKS
              </span>
          ...
          <div className="flex items-center gap-2 overflow-x-auto py-4 border-b border-neutral-200">
            {categories.map((cat) => (
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-normal transition-all duration-300 cursor-pointer whitespace-nowrap ${
                ...
                >
                  ...
                  >
                    ...
                    <div 
                      ...
                      className="absolute top-2.5 right-2.5 px-2 py-0.5 bg-black/60 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-normal"
                    >
                      {proj.category}
                    </div>
                  </div>
                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-[16px] sm:text-[18px] font-semibold tracking-normal text-neutral-950 group-hover:text-neutral-700 leading-snug">
                        {proj.title}
                      </h4>
                    </div>
