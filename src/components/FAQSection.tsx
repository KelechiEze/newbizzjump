...
export const FAQSection = ({ onOpenContact }: FAQSectionProps) => {
  ...
  return (
    <section
      id="faq-section"
      className="w-full px-6 md:px-12 lg:px-16 pt-8 sm:pt-10 md:pt-12 pb-20 sm:pb-28 bg-[#fcfbf9] border-t border-neutral-200/80 select-none"
    >
        ...
        <div className="lg:col-span-5 flex flex-col justify-between">
          ...
          <div className="mt-8 lg:mt-auto pt-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-[#dbfa07] text-black font-medium text-xs sm:text-sm tracking-normal uppercase hover:bg-[#181a33] hover:text-white transition-all duration-300 shadow-sm active:scale-95 cursor-pointer group"
            >
          ...
          {FAQS_DATA.map((item) => {
            ...
            return (
              ...
              >
                ...
                >
                  <h3
                    className={`text-[20px] sm:text-[22px] md:text-[25px] font-medium tracking-tight transition-colors duration-200 ${
