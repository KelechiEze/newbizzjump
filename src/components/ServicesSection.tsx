...
const SERVICES_DATA: ServiceItem[] = [
  ...
  },
  {
    ...
    bulletPoints: ['Shopify storefronts', 'Theme customization', 'Conversion-focused UX'],
    description:
      'We design and customize Shopify stores that feel distinctive, work smoothly, and make buying easy. From storefront structure and product pages to mobile checkout flows, we shape the experience around your brand and your customers.',
  },
  {
    id: 'editorial',
    index: '06',
...
export const ServicesSection = ({ onOpenStartProject }: ServicesSectionProps) => {
  ...
  return (
    <section
      id="services-section"
      className="w-full px-6 md:px-12 lg:px-16 pt-8 sm:pt-12 md:pt-16 pb-20 sm:pb-28 bg-[#fcfbf9] border-t border-neutral-200/80 select-none"
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-12 mb-10 sm:mb-12 md:mb-14">
        ...
        <div className="max-w-md text-left">
          <p className="text-sm sm:text-base md:text-lg font-medium text-neutral-800 leading-snug tracking-tight">
            ...
            branding, marketing, web development, Shopify web design, and editorial.
          </p>
        </div>
      </div>
      ...
      <div
        className="relative left-1/2 -ml-[50vw] w-screen aspect-[16/9] sm:aspect-[16/8] md:aspect-[16/7] min-h-[260px] sm:min-h-[340px] md:min-h-[420px] overflow-hidden bg-neutral-950 mb-14 sm:mb-18 md:mb-20 shadow-sm border-y border-neutral-200/60"
      >
        <video
      ...
      <div className="mt-14 sm:mt-18 md:mt-20 pt-8 border-t border-neutral-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#dbfa07] text-black font-medium text-xs sm:text-sm tracking-normal uppercase rounded-full hover:bg-[#181a33] hover:text-white transition-all duration-300 shadow-sm active:scale-95 cursor-pointer group"
        >
