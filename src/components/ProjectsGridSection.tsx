...
const ProjectCard = ({ project, onSelect }: ProjectCardProps) => {
  ...
  return (
    ...
    >
      {/* Wider project media box keeps the source artwork visible without a tall crop. */}
      <div
        ref={cardRef}
        ...
        className="relative w-full aspect-square md:aspect-[29/28] overflow-hidden bg-neutral-100 shadow-xs transition-shadow duration-300 group-hover:shadow-xl border border-neutral-200/60"
      >
...
export const ProjectsGridSection = ({
  ...
  return (
    <section
      ...
      className="w-full px-6 md:px-12 lg:px-16 pt-0 pb-16 sm:pb-20 bg-[#fcfbf9] border-t border-neutral-200/80 select-none"
    >
      ...
      <div className="mx-auto grid w-full grid-cols-1 gap-x-3 gap-y-6 sm:gap-x-4 sm:gap-y-8 md:max-w-4xl md:grid-cols-2 md:gap-x-5 lg:max-w-5xl">
      ...
      <div className="mt-6 sm:mt-8 md:mt-10 pt-6 border-t border-neutral-200/80 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
        {/* Left Subtext */}
