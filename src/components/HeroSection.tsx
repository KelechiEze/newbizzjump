...
export const HeroSection = ({
  ...
  return (
    <section className="w-full px-6 md:px-12 lg:px-16 pt-6 md:pt-10 pb-12 select-none relative overflow-x-clip">
      ...
      <div className="mb-2 md:mb-4 w-full overflow-visible flex items-center">
        <h1
          id="hero-main-title"
          className="text-[55px] sm:text-7xl md:text-8xl lg:text-[104px] xl:text-[120px] 2xl:text-[132px] font-[900] tracking-[-0.03em] leading-none uppercase flex items-center flex-nowrap overflow-visible cursor-default select-none pr-4 sm:pr-8 text-neutral-900"
        >
          {titleLetters.map((char, idx) => (
            <motion.span
              key={`${char}-${idx}`}
              className={`inline-block relative overflow-visible transform-gpu ${
                idx === titleLetters.length - 1 ? 'text-[#dbfa07]' : ''
              }`}
              style={{
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
        ...
        >
          <p className="text-base sm:text-lg md:text-xl text-[#181a33]/85 font-medium max-w-xl leading-[1.35] mb-6 md:mb-8 tracking-[-0.01em]">
          ...
          <div className="flex flex-wrap items-center gap-4 sm:gap-6">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#dbfa07] text-black rounded-full font-medium text-xs sm:text-sm tracking-normal uppercase hover:bg-[#181a33] hover:text-white active:scale-95 transition-all duration-300 shadow-sm cursor-pointer group"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-3.5 text-neutral-900 font-medium text-xs sm:text-sm tracking-normal uppercase hover:text-neutral-600 active:scale-95 transition-colors cursor-pointer group"
            >
        ...
        >
          <div className="flex flex-col text-[14px] font-medium tracking-normal uppercase text-black">
            ...
            >
              <span className="text-black group-hover:text-black transition-colors flex items-center gap-2">
                RESPONSE TIME
              </span>
              <span className="text-black font-medium text-[14px] font-mono-clean group-hover:underline">
                3H
              </span>
