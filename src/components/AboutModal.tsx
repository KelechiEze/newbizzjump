        ...
        >
          ...
          <div className="pt-4 border-t border-neutral-200 flex items-center justify-end">
            <button
              ...
              className="px-6 py-2.5 bg-[#dbfa07] text-black rounded-full text-xs font-medium tracking-normal uppercase hover:bg-[#181a33] hover:text-white transition-all duration-300 shadow-sm cursor-pointer"
            >
              Collaborate
            </button>
          </div>
