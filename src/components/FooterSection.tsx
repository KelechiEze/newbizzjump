...
const FOOTER_PROJECTS: FooterProjectItem[] = PROJECTS.slice(0, 3).map((project) => ({
  id: project.id,
  title: project.title,
  image: project.image,
}));
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 pt-6">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between min-h-[300px]">
          <div>
            <p className="text-[22px] sm:text-[22px] md:text-[22px] font-normal text-neutral-200 leading-snug tracking-[-0.02em] mb-8 max-w-sm">
        ...
        <div className="lg:col-span-7 flex flex-col justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-12 pt-4">
            ...
            <div className="space-y-3">
              <Link
                to="/about"
                className="block text-xs sm:text-sm font-bold tracking-[0.12em] uppercase text-neutral-300 hover:text-[#dbfa07] transition-colors text-left cursor-pointer"
              >
                ABOUT
              </Link>
              <Link
