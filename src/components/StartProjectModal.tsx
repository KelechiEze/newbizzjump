          ...
          {!isSubmitted ? (
              ...
              <div className="flex items-center justify-between pt-4 border-t border-neutral-200">
                ...
                {step < 3 ? (
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#dbfa07] text-black rounded-full text-xs font-medium tracking-normal uppercase hover:bg-[#181a33] hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300 cursor-pointer shadow-xs"
                  >
                    <span>Continue</span>
            ...
            <div className="py-8 text-center space-y-6">
              ...
              <div>
                <button
                  onClick={handleReset}
                  className="px-7 py-3 bg-[#dbfa07] text-black rounded-full text-xs font-medium tracking-normal uppercase hover:bg-[#181a33] hover:text-white transition-all duration-300 cursor-pointer shadow-xs"
                >
                  Return to Studio
                </button>
              </div>
